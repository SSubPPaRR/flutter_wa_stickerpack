...
public class StickerPackActivity implements PluginRegistry.ActivityResultListener {
    ...
    public static final String ACTION_STICKER_PACK_RESULT = "io/whatsapp_stickers/result";
    public static final String ACTION_STICKER_PACK_ERROR = "io/whatsapp_stickers/error";
